...
% 'Examplefile1_Cas12a.fastqsanger') *Note*: This source of this fastq file is
...
% section of the methods of the acCRISPR manuscript, and specifically "Supplementary table 8".
...
clear
for a=1:1
    [header,sequence] =  fastqread('Examplefile1_Cas12a.fastqsanger'); %imports header and sequence of a fastq reads file of a given sample
