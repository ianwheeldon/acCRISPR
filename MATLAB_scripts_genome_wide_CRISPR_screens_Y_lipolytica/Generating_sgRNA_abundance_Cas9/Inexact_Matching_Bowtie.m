...
tic
clear
bamFilename = 'Examplefile1_Cas9.bam'; %This file will be the result of running bowtie on 'Examplefile1_Cas9.fastqsanger' against the genome file 'CLIB89+control_Cas9.fasta'
...
Ap=cell2mat(All_sgRNA_pos_Cas9(:,4));
c=1;
for i=1:length(Ap)-1
    diff=Ap(i+1)-Ap(i);
    ones(c)=diff;
