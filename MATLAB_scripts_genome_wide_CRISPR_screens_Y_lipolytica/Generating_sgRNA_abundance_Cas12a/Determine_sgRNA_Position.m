...
% Inputs: 'Library_sgRNA_Cas12a.bam': An example BAM file obtained by running
% bowtie on the Cas12a library against the genome file
% 'CLIB89+control_Cas12a.fasta'.

% Outputs: 
% All_sgRNA_pos_Cas12a.mat: variable file that contains all sgRNA names,
...
%library.
tic
bamFilename = 'Library_sgRNA_Cas12a.bam'; %This file will be the result of running bowtie on the Cas12a library against the genome file 'CLIB89+control.fasta' 
...
All_sgRNA_pos_Cas12a=vertcat(A,B,C,D,E,F,H);
save All_sgRNA_pos_Cas12a.mat All_sgRNA_pos_Cas12a
toc