...
% 'Examplefile1_Cas9.fastqsanger') *Note*: This source of this fastq file is
% likley the output of using Trimmomatic on the Illumina raw reads of a
% given sample to keep only the 20 nt sgRNA sequence. For more information
% regarding processing Illumina reads on Galaxy refer "Generating sgRNA read counts from raw reads" 
% section of the methods of the acCRISPR manuscript, and specifically "Supplementary table 9".
...
clear
for a=1:1
    [header,sequence] =  fastqread('Examplefile1_Cas9.fastqsanger'); %imports header and sequence of a fastq reads file of a given sample
